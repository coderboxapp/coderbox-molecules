(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@coderbox/atoms"), require("@coderbox/forms"), require("@coderbox/hocs"), require("classnames"), require("formik"), require("lodash"), require("moment"), require("prop-types"), require("react"), require("react-avatar"), require("react-google-autocomplete"), require("react-markdown"), require("recharts"), require("recompose"), require("styled-components"), require("styled-utils"), require("yup"));
	else if(typeof define === 'function' && define.amd)
		define("coderbox-ui", ["@coderbox/atoms", "@coderbox/forms", "@coderbox/hocs", "classnames", "formik", "lodash", "moment", "prop-types", "react", "react-avatar", "react-google-autocomplete", "react-markdown", "recharts", "recompose", "styled-components", "styled-utils", "yup"], factory);
		...
		root["coderbox-ui"] = factory(root["@coderbox/atoms"], root["@coderbox/forms"], root["@coderbox/hocs"], root["classnames"], root["formik"], root["lodash"], root["moment"], root["prop-types"], root["react"], root["react-avatar"], root["react-google-autocomplete"], root["react-markdown"], root["recharts"], root["recompose"], root["styled-components"], root["styled-utils"], root["yup"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE__coderbox_atoms__, __WEBPACK_EXTERNAL_MODULE__coderbox_forms__, __WEBPACK_EXTERNAL_MODULE__coderbox_hocs__, __WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_formik__, __WEBPACK_EXTERNAL_MODULE_lodash__, __WEBPACK_EXTERNAL_MODULE_moment__, __WEBPACK_EXTERNAL_MODULE_prop_types__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_avatar__, __WEBPACK_EXTERNAL_MODULE_react_google_autocomplete__, __WEBPACK_EXTERNAL_MODULE_react_markdown__, __WEBPACK_EXTERNAL_MODULE_recharts__, __WEBPACK_EXTERNAL_MODULE_recompose__, __WEBPACK_EXTERNAL_MODULE_styled_components__, __WEBPACK_EXTERNAL_MODULE_styled_utils__, __WEBPACK_EXTERNAL_MODULE_yup__) {
...
/***/ "./src/components/CandidateAreaChart/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _recharts = __webpack_require__("recharts");
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    _recharts.AreaChart,
    _extends({ width: 600, height: 300, data: data, margin: { left: -20 } }, props),
    _react2.default.createElement(_recharts.Legend, { layout: 'horizontal', verticalAlign: 'top', height: 40 }),
    _react2.default.createElement(_recharts.XAxis, { dataKey: 'category' }),
...
/***/ "./src/components/CandidateCharts/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _styles = __webpack_require__("./src/components/CandidateCharts/styles.js");

var _CandidateAreaChart = __webpack_require__("./src/components/CandidateAreaChart/index.js");

var _CandidateAreaChart2 = _interopRequireDefault(_CandidateAreaChart);

var _CandidateRadarChart = __webpack_require__("./src/components/CandidateRadarChart/index.js");

var _CandidateRadarChart2 = _interopRequireDefault(_CandidateRadarChart);
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _atoms.Stack,
      { index: stack.index % 2 },
      _react2.default.createElement(_CandidateRadarChart2.default, { data: data }),
      _react2.default.createElement(_CandidateAreaChart2.default, { data: data })
    ),
    _react2.default.createElement(_ToolbarNextPrev2.default, { onNext: stack.next, onPrev: stack.prev })
  );
};

Component.displayName = 'CandidateCharts';

var categories = [{ category: 'frontend', job: 10, profile: 8 }, { category: 'management', job: 10, profile: 8 }, { category: 'mobile', job: 10, profile: 8 }, { category: 'backend', job: 10, profile: 8 }, { category: 'embedded', job: 10, profile: 8 }, { category: 'database', job: 10, profile: 8 }];

var withChartData = (0, _recompose.mapProps)(function (_ref2) {
  var candidate = _ref2.candidate;

  var jobMin = 10;
  var profileMin = 8;
  var data = categories.concat();
  var jobRadar = candidate.job.radar;
  var profileRadar = candidate.profile.radar;

  (0, _lodash.each)(profileRadar.categories, function (c) {
    var entry = (0, _lodash.find)(data, function (e) {
      return e.category === c.name;
    });
  ...
  (0, _lodash.each)(jobRadar.categories, function (c) {
    var entry = (0, _lodash.find)(data, function (e) {
      return e.category === c.name;
    });
...
exports.default = (0, _recompose.compose)(withChartData, _hocs.withStack)(Component);

/***/ }),

/***/ "./src/components/CandidateCharts/styles.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Container = exports.Container = _styledComponents2.default.div.withConfig({
  displayName: 'styles__Container'
})(['max-width:620px;text-align:center;box-shadow:0 2px 3px rgba(10,10,10,0.1),0 0 0 1px rgba(10,10,10,0.1);padding:1rem;border-radius:5px;']);

/***/ }),

/***/ "./src/components/CandidateRadarChart/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _extends({ cx: 300, cy: 190, outerRadius: 150, width: 580, height: 400, data: data }, props),
    _react2.default.createElement(_recharts.PolarGrid, { gridType: 'circle', stroke: '#eee', strokeWidth: 2 }),
    _react2.default.createElement(_recharts.PolarAngleAxis, { dataKey: 'category' }),
    _react2.default.createElement(_recharts.Tooltip, null),
    _react2.default.createElement(_recharts.Legend, { align: 'left', layout: 'horizontal', verticalAlign: 'top' }),
    _react2.default.createElement(_recharts.Radar, {
      name: 'Job',
      dataKey: 'job',
      fill: '#5fba7d',
      stroke: '#5fba7d',
...
/***/ "./src/components/JobExtra/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _styles = __webpack_require__("./src/components/JobExtra/styles.js");
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _atoms.Link,
      null,
      _react2.default.createElement(_atoms.Icon, { name: 'bar-chart', color: 'gray' }),
      views,
      ' view(s)'
    ),
    _react2.default.createElement(
      _atoms.Link,
      { href: '/app/candidates/' + job._id },
      _react2.default.createElement(_atoms.Icon, { name: 'inbox', color: 'gray' }),
      candidates.length,
      ' candidate(s)'
    )
  );
...
/***/ "./src/components/JobExtra/styles.js":
/***/ (function(module, exports, __webpack_require__) {
...
var JobExtra = exports.JobExtra = _styledComponents2.default.div.withConfig({
  displayName: 'styles__JobExtra'
})(['padding:0.6em;background:#F8F9FD;border:1px solid;border-color:#f1f1f1;border-radius:5px;margin-top:0.6em;& > a{margin-right:1.2em;}']);
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _elements.Tags,
      { color: 'white', tags: tags },
      job.paid && _react2.default.createElement(
        _atoms.Group,
        null,
        _react2.default.createElement(
          _atoms.Tag,
          { color: 'success', tone: 1, isIcon: true },
          _react2.default.createElement(_atoms.Icon, { name: 'gift' })
        ),
        _react2.default.createElement(
          _atoms.Tag,
          { color: 'success' },
      ...
      job.teamWork && _react2.default.createElement(
        _atoms.Group,
        null,
        _react2.default.createElement(
          _atoms.Tag,
          { color: 'accent', tone: 1, isIcon: true },
          _react2.default.createElement(_atoms.Icon, { name: 'male' })
        ),
        _react2.default.createElement(
          _atoms.Tag,
          { color: 'accent' },
...
exports.UserProfile = exports.TimelineRow = exports.Timeline = exports.ToolbarEditDelete = exports.ToolbarNextPrev = exports.JobExtra = exports.JobHeader = exports.CompanyProfile = exports.CandidateCharts = exports.AutocompleteLocation = undefined;
...
var _JobExtra = __webpack_require__("./src/components/JobExtra/index.js");

var _JobExtra2 = _interopRequireDefault(_JobExtra);
...
var _CandidateCharts = __webpack_require__("./src/components/CandidateCharts/index.js");

var _CandidateCharts2 = _interopRequireDefault(_CandidateCharts);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.AutocompleteLocation = _AutocompleteLocation2.default;
exports.CandidateCharts = _CandidateCharts2.default;
exports.CompanyProfile = _CompanyProfile2.default;
exports.JobHeader = _JobHeader2.default;
exports.JobExtra = _JobExtra2.default;
...
var DateRange = function DateRange(_ref) {
  ...
  var startDate = (0, _moment2.default)(dateRange.start).format('MMM/YYYY');
  var endDate = dateRange.end ? (0, _moment2.default)(dateRange.end).format('MMM/YYYY') : 'Present';
...
})(['display:flex;align-items:center;& .icon.arrow{margin:0 0.3rem;}& .icon.calendar{width:auto;margin-right:0.3rem;}']);
...
var _styles = __webpack_require__("./src/elements/DaysAgo/styles.js");
...
/***/ "./src/elements/DaysAgo/styles.js":
/***/ (function(module, exports, __webpack_require__) {
...
var DaysAgo = exports.DaysAgo = _styledComponents2.default.div.withConfig({
  displayName: 'styles__DaysAgo'
})(['& .icon{width:auto;margin-right:0.3rem;}']);
...
var Component = function Component(_ref) {
  var tags = _ref.tags,
      margin = _ref.margin,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ['tags', 'margin', 'children']);
...
})(['margin:', ';display:inline-flex;flex-wrap:wrap;& .tag{margin-bottom:0.25em;}& .group:not(:last-child){margin:0 0.25em 0 0;}'], function (p) {
...
var Component = function Component(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _forms.Field,
      { label: 'Institution:', isRequired: true },
      _react2.default.createElement(
        _forms.Control,
        { hasLeftIcon: true },
...
var Component = function Component(_ref) {
  var values = _ref.values,
      ...
      onCancel = _ref.onCancel,
      onSubmitComplete = _ref.onSubmitComplete,
      props = _objectWithoutProperties(_ref, ['values', 'errors', 'status', 'isSubmitting', 'suggestions', 'handleChange', 'handleSubmit', 'onCancel', 'onSubmitComplete']);
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_forms.Dropdown, {
          ...
          value: values.technologies,
          onChange: function onChange(t) {
            return props.setFieldValue('technologies', t);
          },
          placeholder: 'Type technologies'
        })
      )
      ...
      _react2.default.createElement(
        _forms.Checkbox,
        {
          ...
          onChange: function onChange(e, checked) {
            return props.setFieldValue('published', checked);
          } },
        'Published'
      )
    ),
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _forms.Checkbox,
        {
          ...
          checked: values.paid,
          onChange: function onChange(e, checked) {
            return props.setFieldValue('paid', checked);
          } },
        'Paid'
      )
    ),
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        _forms.Checkbox,
        {
          ...
          onChange: function onChange(e, checked) {
            return props.setFieldValue('teamWork', checked);
          } },
        'Team Work'
      )
    ),
...
var withFormik = (0, _formik.Formik)({
  validateOnChange: true,
  validationSchema: (0, _yup.object)().shape({
    title: (0, _yup.string)().min(3, 'Title has to be at least 3 characters long.').required('Title is required'),
    description: (0, _yup.string)().min(5, 'Description has to be at least 5 characters long.').required()
  }),
  mapPropsToValues: function mapPropsToValues(_ref2) {
    var data = _ref2.data;
    return _extends({}, data);
...
exports.createForm = exports.UserProfileForm = exports.JobForm = exports.EducationForm = exports.PositionForm = exports.LoginForm = undefined;
...
var _JobForm = __webpack_require__("./src/forms/JobForm/index.js");
...
var createForm = function createForm(data, props) {
  var map = {
    'position': _PositionForm2.default,
    'education': _EducationForm2.default,
    'user': _UserProfileForm2.default,
    'internship': _JobForm2.default,
    'job': _JobForm2.default
  };
...
exports.JobForm = _JobForm2.default;
...
exports.createItem = exports.createForm = exports.UserProfile = exports.TimelineRow = exports.Timeline = exports.ToolbarEditDelete = exports.ToolbarNextPrev = exports.JobExtra = exports.JobHeader = exports.CompanyProfile = exports.AutocompleteLocation = exports.UserProfileForm = exports.JobForm = exports.EducationForm = exports.PositionForm = exports.LoginForm = exports.CandidateItem = exports.EducationItem = exports.PositionItem = exports.EditableItem = exports.JobItem = exports.Item = exports.Tags = exports.Markdown = exports.Location = exports.DaysAgo = exports.DateRange = exports.Avatar = undefined;
...
var _CandidateItem = __webpack_require__("./src/items/CandidateItem/index.js");

var _CandidateItem2 = _interopRequireDefault(_CandidateItem);
...
exports.CandidateItem = _CandidateItem2.default;
exports.LoginForm = _LoginForm2.default;
exports.PositionForm = _PositionForm2.default;
exports.EducationForm = _EducationForm2.default;
exports.JobForm = _JobForm2.default;
...
exports.TimelineRow = _TimelineRow2.default;
exports.UserProfile = _UserProfile2.default;
exports.createForm = _forms.createForm;
exports.createItem = _items.createItem;
...
/***/ "./src/items/CandidateItem/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
var _styles = __webpack_require__("./src/items/CandidateItem/styles.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Component = function Component(_ref) {
  var data = _ref.data,
      showCharts = _ref.showCharts,
      toggleCharts = _ref.toggleCharts;
  var profile = data.profile,
      job = data.job;

  var technologies = (0, _lodash.intersectionBy)(profile.radar.technologies, job.radar.technologies, function (t) {
    return t.name;
  });
  var score = Math.round((technologies.length + 0.5) / job.radar.technologies.length * 100);
  ...
  return _react2.default.createElement(
    _.Item,
    { email: profile.email },
    _react2.default.createElement(_elements.DaysAgo, { date: data.createdAt }),
    _react2.default.createElement(
      _atoms.Title,
      { size: 'large' },
      profile.name
    ...
    _react2.default.createElement(
      _atoms.Text,
      { color: score > 30 ? 'success' : 'danger', tone: 1 },
      'Score: ',
      _react2.default.createElement(
        'b',
        null,
    ...
    _react2.default.createElement(_elements.Tags, { tags: profile.radar.technologies }),
    _react2.default.createElement(
      _styles.Toolbar,
      null,
      _react2.default.createElement(
        _atoms.Button,
        { href: '/app/' + profile._id, color: 'primary', size: 'small', target: '_blank', isIcon: true },
        _react2.default.createElement(_atoms.Icon, { name: 'user' })
      ),
      _react2.default.createElement(
        _atoms.Button,
        { color: 'gray', tone: '2', size: 'small', isIcon: true, isInverted: showCharts, onClick: toggleCharts },
        _react2.default.createElement(_atoms.Icon, { name: 'area-chart' })
      )
    ),
    showCharts && _react2.default.createElement(_components.CandidateCharts, { candidate: data })
  );
};

Component.displayName = 'CandidateItem';

var withChartsToggle = (0, _recompose.compose)((0, _recompose.withState)('showCharts', 'setShowCharts', false), (0, _recompose.withHandlers)({
  toggleCharts: function toggleCharts(_ref2) {
    var setShowCharts = _ref2.setShowCharts;
    return function () {
      return setShowCharts(function (show) {
        return !show;
      });
    };
  }
...
exports.default = (0, _recompose.compose)(withChartsToggle)(Component);

/***/ }),

/***/ "./src/items/CandidateItem/styles.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Toolbar = exports.Toolbar = _styledComponents2.default.div.withConfig({
  displayName: 'styles__Toolbar'
})(['margin:0.5em;position:absolute;top:0;right:0;']);
  ...
  _createClass(Component, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['data', 'stack', 'onSave', 'onDelete', 'suggestions', 'hideToolbar']);
      ...
      var Item = factory.createItem(data, props);
      ...
      return React.createElement(
        ...
        !hideToolbar && React.createElement(_components.ToolbarEditDelete, {
          isFixed: true,
          index: stack.index,
...
var Component = function Component(_ref) {
  var image = _ref.image,
      ...
      tag = _ref.tag,
      children = _ref.children,
      props = _objectWithoutProperties(_ref, ['image', 'email', 'tag', 'children']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _styles.ItemLeft,
      null,
      _react2.default.createElement(_elements.Avatar, { email: email, src: image, size: 60 }),
      tag
    ),
    _react2.default.createElement(
      _styles.ItemContent,
...
})(['margin:0;padding:0;display:flex;flex-direction:column;& .tag{padding:0 0.35rem;}']);

var ItemContent = exports.ItemContent = _styledComponents2.default.div.withConfig({
  displayName: 'styles__ItemContent'
})(['display:block;margin-left:0;padding-left:1.2em;flex:1;.subtitle{margin-bottom:0.5em !important;}']);
...
var Component = function Component(_ref) {
  ...
  var tagColor = data.published ? 'primary' : 'gray';
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _.Item,
      { image: data.company.logo, tag: tag },
      _react2.default.createElement(_elements.DaysAgo, { date: data.createdAt }),
      _react2.default.createElement(
        _atoms.Link,
        { href: href, color: 'black' },
        _react2.default.createElement(
          _atoms.Title,
          { size: 'large' },
          data.title
      ...
      data.type === 'job' && _react2.default.createElement(
        _atoms.Text,
      ...
      _react2.default.createElement(
        ...
        data.paid && _react2.default.createElement(
          _atoms.Group,
          null,
          _react2.default.createElement(
            _atoms.Tag,
        ...
        data.teamWork && _react2.default.createElement(
          _atoms.Group,
          null,
          _react2.default.createElement(
            _atoms.Tag,
      ...
      showDesc && _react2.default.createElement(_elements.Markdown, { source: data.description })
    )
  );
};
...
exports.createItem = exports.EducationItem = exports.CandidateItem = exports.PositionItem = exports.JobItem = exports.EditableItem = exports.Item = undefined;
...
var createItem = function createItem(data, props) {
  var map = {
    'position': _PositionItem2.default,
    'education': _EducationItem2.default,
    'internship': _JobItem2.default,
    'candidate': _CandidateItem2.default,
    'job': _JobItem2.default
  };
